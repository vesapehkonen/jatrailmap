...
public final class DiagnosticLog {
    private static final String LOGCAT_TAG = "JATM";
    ...
    private static final String EXPORT_FILE = "jatrailmap-diagnostics.txt";
    ...
    public static File createExportFile(Context context) throws IOException {
        synchronized (FILE_LOCK) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
                ...
                writer.write("Just Another Trail Map diagnostics");
                writer.newLine();
